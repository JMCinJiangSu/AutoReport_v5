...
def process_hd(jsonDict, config):
	...
	# 2026.07.15-内蒙古自治区人民医院-JY CP200要展示HD
	# 2026.08.27-新增BRCA（HD）
	if judge_hd_inter and (jsonDict["sample_info"]["prod_names"] in ["Master Panel（组织）", "Master Panel", "HANDLE OncoPro", "HANDLE OncoPro Compact", "Master Panel（组织_北医）", "BHD（组织）", "BRCA（前列腺癌）", "BRCA（HD）"] or \
						...
						(jsonDict["sample_info"]["prod_names"] in ["OncoPro（组织）", "Classic Panel 200（组织）"] and jsonDict["sample_info"]["origin_company"] in ["南充市中心医院-JY"] and jsonDict["sample_info"]["report_module_type"] == "rummage") or \
						(jsonDict["sample_info"]["prod_names"] in ["OncoPro（组织）", "Classic Panel 200（组织）"] and jsonDict["sample_info"]["origin_company"] in ["内蒙古自治区人民医院-JY"] and jsonDict["sample_info"]["report_module_type"] == "rummage") or \
						(jsonDict["sample_info"]["prod_names"] in ["OncoPro（组织）", "Classic Panel 200（组织）"] and jsonDict["sample_info"]["company"] == "内蒙古自治区人民医院" and jsonDict["sample_info"]["report_module_type"] == "hospital")):
		for var in hd:
